        ...
        <form onSubmit={(event) => props.submit(event)}>
          ...
          <div className='flex items-center'>
            <button
              ...
              {props.buttonText} book
            </button>

            <Link
              to='/dashboard'
              className='text-gray-900 mt-8 bg-white border border-gray-300 focus:outline-none hover:bg-gray-100 font-medium rounded-lg ml-2.5 text-sm px-5 py-2.5 me-2 mb-2 dark:bg-gray-800'>
              Go dashboard
            </Link>
          </div>
        </form>
